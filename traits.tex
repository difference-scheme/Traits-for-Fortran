...
Chapter~\ref{sect:survey}, we will then re-code this test problem in an
...
inter-operable with the single implementation inheritance (i.e. subclassing)
...
economical, and that automatic type inference by the compiler should
...
possible, but it is as easy to do as using the functional programming
...
the future. Decoupled software plugin architectures with enormously
improved flexibility, maintainability, reusability, and reliability
will become possible, without any loss in computational performance.
