...
...
\end{lstlisting}
that extends this \code{Base} type, must then implement the
...
\begin{abstract}
  ...
  our work. Brad Richardson reported an inconsistency in an earlier
  version of the manuscript, which has helped us to improve this
  paper.
\end{abstract}
