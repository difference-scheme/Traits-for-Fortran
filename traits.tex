...
interfaces in the language (which presently serve as bounds on the
...
polymorphism, or indirectly as constraints on generic type parameters
in compile-time polymorphism (see Sect.~\ref{sect:generic_parameters}
