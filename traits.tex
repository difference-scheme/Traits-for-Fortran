...
new abstract interfaces that are the merger of \emph{multiple} simpler
...
\subsection{Short-hand notation for merged abstract interfaces}

There are often cases where the merger of two (or more) interfaces is
...
\emph{unions} of member types as a type set. Such a type set is
...
types \cite{Taylor_21,Pierce_91} (which would ultimately take this
design to its logical conclusion, offer an alternative to generic
