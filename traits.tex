...
manual instantiation. A better solution, though, is to allow
...
of monomorphization, that is based on static method dispatch. In
contrast to traditional (run-time) OO polymorphism, that is based on
...
\emph{minimally} changed version of the encapsulated Fortran code of
