...
language intrinsic types as arguments to methods, thus allowing for a
maximum of code reuse. Notice, in particular, how the main program is
the only part of the code that (necessarily) depends on
implementations. The \emph{entire} rest of the code is decoupled,
